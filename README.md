...
| **Collaborate & sustain** | `orchestrating-subagents` · `running-multi-lens-audits` · `supervising-autonomous-sessions` · `handing-off-sessions` · `writing-agent-context-files` · `keeping-docs-in-sync` · `keeping-repos-portable` · `committing-and-releasing-cleanly` |
