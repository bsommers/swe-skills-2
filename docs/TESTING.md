...
| `writing-user-guides` | "Write a user guide for this tool; no docs currently exist." | Creates `docs/user-guide/` with TOC, Getting Started, Examples, Reference; creates or updates root `README.md` with links to the guide and backlinks to README; uses relative paths |
